...
export function NewMemoryForm() {
  ...
  return (
    <form onSubmit={handleCreateMemory} className="flex flex-1 flex-col gap-2">
      ...
      <button
        type="submit"
        className="inline-block self-end rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black transition-colors duration-300 hover:bg-green-700 hover:text-gray-50"
      >
        Salvar
      </button>
    </form>
